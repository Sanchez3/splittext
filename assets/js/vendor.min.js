!function(e) {
    ...
    window.webpackJsonp = function(o, a, i) {
        for (var u, s, d, _ = 0, l = []; _ < o.length; _++) s = o[_], r[s] && l.push(r[s][0]), 
        r[s] = 0;
        for (u in a) Object.prototype.hasOwnProperty.call(a, u) && (e[u] = a[u]);
        t && t(o, a, i);
        while (l.length) l.shift()();
        if (i) for (_ = 0; _ < i.length; _++) d = n(n.s = i[_]);
        return d;
    };
    var o = {}, r = {
        1: 0
    ...
    n.e = function(e) {
        ...
        u.type = "text/javascript", u.charset = "utf-8", u.async = true, u.timeout = 12e4, 
        n.nc && u.setAttribute("nonce", n.nc), u.src = n.p + "assets/js/" + e + ".min.js";
        ...
        !function() {
            ...
            a.prototype = {
                ...
                _enableMobileAudio: function() {
                    ...
                    if (!e._mobileEnabled && e.ctx && (n || t)) {
                        e._mobileEnabled = false, e._mobileUnloaded || 44100 === e.ctx.sampleRate || (e._mobileUnloaded = true, 
                        e.unload()), e._scratchBuffer = e.ctx.createBuffer(1, 1, 22050);
                        var o = function() {
                            i._autoResume();
                            var n = e.ctx.createBufferSource();
                            n.buffer = e._scratchBuffer, n.connect(e.ctx.destination), void 0 === n.start ? n.noteOn(0) : n.start(0), 
                            "function" == typeof e.ctx.resume && e.ctx.resume(), n.onended = function() {
                                n.disconnect(0), e._mobileEnabled = true, e.mobileAutoEnable = false, document.removeEventListener("touchstart", o, true), 
                                document.removeEventListener("touchend", o, true);
                            };
                        };
                        return document.addEventListener("touchstart", o, true), document.addEventListener("touchend", o, true), 
                        e;
                    }
                },
            ...
            u.prototype = {
                init: function(e) {
                    ...
                    n._volume = void 0 !== e.volume ? e.volume : 1, n._xhrWithCredentials = e.xhrWithCredentials || false, 
                    n._duration = 0, n._state = "unloaded", n._sounds = [], n._endTimers = {}, n._queue = [], 
                    n._onend = e.onend ? [ {
                        fn: e.onend
                    } ] : [], n._onfade = e.onfade ? [ {
                        fn: e.onfade
                ...
                load: function() {
                    ...
                    for (var t = 0; t < e._src.length; t++) {
                        var o, r;
                        if (e._format && e._format[t]) o = e._format[t]; else {
                ...
                play: function(e, n) {
                    ...
                    if (t._webAudio) {
                        var f = function() {
                            ...
                            c.gain.setValueAtTime(e, i.ctx.currentTime), u._playStart = i.ctx.currentTime, void 0 === c.bufferSource.start ? u._loop ? c.bufferSource.noteGrainOn(0, d, 86400) : c.bufferSource.noteGrainOn(0, d, _) : u._loop ? c.bufferSource.start(0, d, 86400) : c.bufferSource.start(0, d, _), 
                            l !== 1 / 0 && (t._endTimers[u._id] = setTimeout(t._ended.bind(t, u), l)), n || setTimeout(function() {
                                t._emit("play", u._id);
                            }, 0);
                        };
                        "running" === i.state ? f() : (t.once("resume", f), t._clearTimer(u._id));
                    } else {
                        var p = function() {
                            c.currentTime = d, c.muted = u._muted || t._muted || i._muted || c.muted, c.volume = u._volume * i.volume(), 
                            c.playbackRate = u._rate;
                            try {
                                if (c.play(), c.paused) return void t._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices where playback was not within a user interaction.");
                                l !== 1 / 0 && (t._endTimers[u._id] = setTimeout(t._ended.bind(t, u), l)), n || t._emit("play", u._id);
                            } catch (e) {
                                t._emit("playerror", u._id, e);
                            }
                        }, v = window && window.ejecta || !c.readyState && i._navigator.isCocoonJS;
                        if (4 === c.readyState || v) p(); else {
                            var m = function() {
                                p(), c.removeEventListener(i._canPlayEvent, m, false);
                            };
                            c.addEventListener(i._canPlayEvent, m, false), t._clearTimer(u._id);
                        }
                    }
                    return u._id;
                },
                pause: function(e) {
                    ...
                    for (var t = n._getSoundIds(e), o = 0; o < t.length; o++) {
                        ...
                        if (r && !r._paused && (r._seek = n.seek(t[o]), r._rateSeek = 0, r._paused = true, 
                ...
                stop: function(e, n) {
                    ...
                    for (var o = t._getSoundIds(e), r = 0; r < o.length; r++) {
                        ...
                        a && (a._seek = a._start || 0, a._rateSeek = 0, a._paused = true, a._ended = true, 
                        t._stopFade(o[r]), a._node && (t._webAudio ? a._node.bufferSource && (void 0 === a._node.bufferSource.stop ? a._node.bufferSource.noteOff(0) : a._node.bufferSource.stop(0), 
                ...
                volume: function() {
                    ...
                    for (var a = 0; a < n.length; a++) (r = t._soundById(n[a])) && (r._volume = e, o[2] || t._stopFade(n[a]), 
                    t._webAudio && r._node && !r._muted ? r._node.gain.setValueAtTime(e, i.ctx.currentTime) : r._node && !r._muted && (r._node.volume = e * i.volume()), 
                    ...
                    for (var a = r._getSoundIds(o), u = 0; u < a.length; u++) {
                        ...
                        if (s) {
                            if (o || r._stopFade(a[u]), r._webAudio && !s._muted) {
                                var d = i.ctx.currentTime, _ = d + t / 1e3;
                                s._volume = e, s._node.gain.setValueAtTime(e, d), s._node.gain.linearRampToValueAtTime(n, _);
                            }
                            r._startFadeInterval(s, e, n, t, a[u]);
                        }
                    }
                    return r;
                },
                _startFadeInterval: function(e, n, t, o, r) {
                    var a = this, i = n, u = n > t ? "out" : "in", s = Math.abs(n - t), d = s / .01, _ = d > 0 ? o / d : o;
                    _ < 4 && (d = Math.ceil(d / (4 / _)), _ = 4), e._interval = setInterval(function() {
                        d > 0 && (i += "in" === u ? .01 : -.01), i = Math.max(0, i), i = Math.min(1, i), 
                        i = Math.round(100 * i) / 100, a._webAudio ? (void 0 === r && (a._volume = i), e._volume = i) : a.volume(i, e._id, true), 
                        (t < n && i <= t || t > n && i >= t) && (clearInterval(e._interval), e._interval = null, 
                        a.volume(t, e._id), a._emit("fade", e._id));
                    }, _);
                },
                ...
                rate: function() {
                    var e, n, t = this, o = arguments;
                    if (0 === o.length) n = t._sounds[0]._id; else if (1 === o.length) {
                    ...
                    for (var s = 0; s < n.length; s++) if (u = t._soundById(n[s])) {
                        u._rateSeek = t.seek(n[s]), u._playStart = t._webAudio ? i.ctx.currentTime : u._playStart, 
                        u._rate = e, t._webAudio && u._node && u._node.bufferSource ? u._node.bufferSource.playbackRate.value = e : u._node && (u._node.playbackRate = e);
                ...
                seek: function() {
                    ...
                    if (u) {
                        ...
                        var _ = t.playing(n);
                        _ && t.pause(n, true), u._seek = e, u._ended = false, t._clearTimer(n), _ && t.play(n, true), 
                ...
                unload: function() {
                    for (var e = this, n = e._sounds, t = 0; t < n.length; t++) {
                        if (n[t]._paused || e.stop(n[t]._id), !e._webAudio) {
                        ...
                        delete n[t]._node, e._clearTimer(n[t]._id);
                ...
                _ended: function(e) {
                    ...
                    if (!n._webAudio && e._node && !e._node.paused) return setTimeout(n._ended.bind(n, e), 100), 
                    n;
                    var o = !!(e._loop || n._sprite[t][2]);
                    if (n._emit("end", e._id), !n._webAudio && o && n.stop(e._id, true).play(e._id), 
                    n._webAudio && o) {
            ...
            var d = {}, _ = function(e) {
                var n = e._src;
                if (d[n]) return e._duration = d[n].duration, void f(e);
                if (/^data:[^;]+;base64,/.test(n)) {
                    for (var t = atob(n.split(",")[1]), o = new Uint8Array(t.length), r = 0; r < t.length; ++r) o[r] = t.charCodeAt(r);
                    c(o.buffer, e);
                } else {
                    var a = new XMLHttpRequest();
                    a.open("GET", n, true), a.withCredentials = e._xhrWithCredentials, a.responseType = "arraybuffer", 
                    a.onload = function() {
                        var n = (a.status + "")[0];
            ...
            }.apply(n, o)) && (e.exports = r), n.Howler = i, n.Howl = u, "undefined" != typeof window ? (window.HowlerGlobal = a, 
            window.Howler = i, window.Howl = u, window.Sound = s) : void 0 !== t && (t.HowlerGlobal = a, 
            t.Howler = i, t.Howl = u, t.Sound = s);
        }(), function() {
            "use strict";
            ...
            HowlerGlobal.prototype.stereo = function(e) {
                ...
                for (var a = o._getSoundIds(t), i = 0; i < a.length; i++) {
                    ...
                    if (u) {
                        ...
                        u._stereo = n, u._pos = [ n, 0, 0 ], u._node && (u._pannerAttr.panningModel = "equalpower", 
                ...
                for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                    ...
                    if (s) {
                        ...
                        s._pos = [ n, t, o ], s._node && (s._panner && !s._panner.pan || e(s, "spatial"), 
                        s._panner.setPosition(n, t, o)), a._emit("pos", s._id);
                    }
                }
                return a;
                ...
                if (t = "number" != typeof t ? a._orientation[1] : t, o = "number" != typeof o ? a._orientation[2] : o, 
                void 0 === r) {
                ...
                for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                    ...
                    if (s) {
                        ...
                        s._orientation = [ n, t, o ], s._node && (s._panner || (s._pos || (s._pos = a._pos || [ 0, 0, -.5 ]), 
                        e(s, "spatial")), s._panner.setOrientation(n, t, o)), a._emit("orientation", s._id);
                    }
                }
                return a;
                ...
                for (var i = r._getSoundIds(t), u = 0; u < i.length; u++) if (o = r._soundById(i[u])) {
                    ...
                    d.distanceModel = s.distanceModel, d.maxDistance = s.maxDistance, d.refDistance = s.refDistance, 
                    d.rolloffFactor = s.rolloffFactor, d.panningModel = s.panningModel) : (o._pos || (o._pos = r._pos || [ 0, 0, -.5 ]), 
                    e(o, "spatial"));
                }
                return r;
                ...
                return function() {
                    ...
                    e.call(this), n._stereo ? t.stereo(n._stereo) : n._pos && t.pos(n._pos[0], n._pos[1], n._pos[2], n._id);
                };
            ...
            var e = function(e, n) {
                n = n || "spatial", "spatial" === n ? (e._panner = Howler.ctx.createPanner(), e._panner.coneInnerAngle = e._pannerAttr.coneInnerAngle, 
                ...
                e._panner.panningModel = e._pannerAttr.panningModel, e._panner.setPosition(e._pos[0], e._pos[1], e._pos[2]), 
                e._panner.setOrientation(e._orientation[0], e._orientation[1], e._orientation[2])) : (e._panner = Howler.ctx.createStereoPanner(), 
                e._panner.pan.value = e._stereo), e._panner.connect(e._node), e._paused || e._parent.pause(e._id, true).play(e._id);
            };
        }();
    }).call(n, t(2));
}, function(e, n) {
